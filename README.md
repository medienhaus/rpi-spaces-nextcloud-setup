...
3. Clone, start, and install [nextcloud](/nextcloud/)
   <br>
   ```bash
   ...
   ⚠️ For *production*, please change the following lines❗️
      - `server_name example.org` to point to your *fully qualified domain name*
...
2. Clone, start, and install [nextcloud](/nextcloud/)
   <br>
   ```bash
   cd nextcloud/ && \
   cp .env.example .env
